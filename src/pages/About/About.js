  ...
  <PageContainer className="about">
    <Grid container>
      ...
      <Grid item xs={12} sm={8} md={6} lg={5} xl={4} className="description">
        ...
        <p>Taylor Zanke Office is the independent design practice of artist <a href="http://taylorzanke.com">Taylor Zanke</a>. The practice operates across disciplinary boundaries and looks for opportunities to translate knowledge and understanding through project types with fluidity and dexterity. Taylor is interested in developing collaborations and partnerships with individuals or institutions to communicate, define, and present ideas, stories, and values. A focus on engaging in contemporary culture encourages broad consideration of the media and format of communication and representation. Through this process, the practice seeks to develop ways of meeting an audience or expressing relevance that are unexpected. Taylor has a particular interest in the process of designing and its potential to provide a reflective context for all stakeholders by helping to translate sensibilities and concepts into form.</p>
